...
int main() {
    ...
    cin >> a >> b >> c;
    a--;b--;c--;
    dinic<ll> din(2*n+105);
    rep(i,m){
        ll u,v;
        cin >> u >> v;
        u--;v--;
        din.add_edge(u,n+v,1);
        din.add_edge(v,n+u,1);
    }
    rep(i,n) din.add_edge(n+i,i,1);
    din.add_edge(a,2*n,1);
    din.add_edge(c,2*n,1);
    ll check=din.max_flow(b,2*n);
