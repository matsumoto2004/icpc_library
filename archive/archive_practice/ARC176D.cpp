...
int main() {
    ...
    mint num1=0;
    {
        ...
        rep(i,m){
            mint now0=dp[i][0];
            mint now1=dp[i][1];
            dp[i+1][1]+=now1*(n-2)*(n-3)/2;
            dp[i+1][1]+=now1*3;
            dp[i+1][0]+=now1*(n*(n-1)/2-(n-2)*(n-3)/2-3);
            dp[i+1][1]+=now0*4;
            dp[i+1][0]+=now0*(n*(n-1)/2-4);
        }
        num1=dp[m][1];
    }
    ...
    mint num3=0;
    {
        ...
        dp[0][2]=1;
        rep(i,m){
            dp[i+1][2]+=dp[i][2]*(1+(n-2)*(n-3)/2);
            dp[i+1][1]+=dp[i][2]*2*(n-2);
            dp[i+1][2]+=dp[i][1];
            dp[i+1][1]+=dp[i][1]*(n*(n-1)/2-(n-2));
            dp[i+1][0]+=dp[i][1]*(n-3);
            dp[i+1][1]+=dp[i][0]*4;
            dp[i+1][0]+=dp[i][0]*(n*(n-1)/2-4);
        }
        num3=dp[m][2];
    }
    mint num4=0;
    ...
    debug(num1,num2,num3,num4,num5);
}
