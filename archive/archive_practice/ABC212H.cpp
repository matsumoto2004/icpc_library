...
int main() {
    ...
    rrep(i,len){
        {
            vm n_dp1=convolution_xor(dp1,dp1) ,n_dp2=convolution_xor(dp1,dp2);
            rep(j,big) n_dp2[j]+=dp2[j];
            swap(dp1,n_dp1);
            swap(dp2,n_dp2);
        }
        //print(dp1.size(),dp2.size());
        if((n>>i)&1){
            vm n_dp1=convolution_xor(dp1,v),n_dp2=n_dp1;
            rep(j,big) n_dp2[j]+=dp2[j];
            swap(dp1,n_dp1);
            swap(dp2,n_dp2);
        }
