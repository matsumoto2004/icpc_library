...
int main() {
    ...
    //rep(i,10) print(prob[i]);

    ld clear=0;
    rep(i,n,n+m) clear+=prob[i];
    ld miss=1-clear;
    if(clear<numeric_limits<double>::epsilon()){
        fin(-1);
    }

    vector<ld> exp(n+1+2e5,0);
